...
book2 <-  ggdraw() + draw_image("https://geocompr.robinlovelace.net/images/cover.png")
plot_grid(book1, book2)
```
...
Propose a fancy graph to visualize the relation between flipper and body mass. Does this relation chance over year ?
