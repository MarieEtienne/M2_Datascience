...
---
name: ggplot
# Vizualization thanks to ggplot
...
## Vizualizing the relation between Body weight and Brain weight among bats species
...
# Porperly labeled colored graph
...
```{r color_hist_cor}
penguins %>%
  ggplot() + aes(x = bill_l, fill = species) + geom_histogram(  position = "identity", alpha = 0.5) +
  labs( x = 'Bill length in mm') +
